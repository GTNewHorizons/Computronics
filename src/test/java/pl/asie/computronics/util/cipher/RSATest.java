...
class RSATest {
    ...
    private static void testRSA(String msg, boolean swapKeys, int repeat) throws Exception {
        ...
        for (int i = 0; i < repeat; i++) {
            ...
            String encoded = Base64.encodeBytes(message.modPow(d, n).toByteArray());
            // String wrongencoded =
            // "";
    ...
    private static void testRSA2(String msg) throws Exception {
        ...
        RSAPublicKey deserializedPub = (RSAPublicKey) kf
                .generatePublic(new X509EncodedKeySpec(Base64.decode(Base64.encodeBytes(pubKey.getEncoded()))));
        RSAPublicKey deserializedPub2 = (RSAPublicKey) kf.generatePublic(
        ...
        RSAPrivateKey deserializedPriv = (RSAPrivateKey) kf
                .generatePrivate(new PKCS8EncodedKeySpec(Base64.decode(Base64.encodeBytes(privKey.getEncoded()))));
        RSAPrivateKey deserializedPriv2 = (RSAPrivateKey) kf.generatePrivate(
