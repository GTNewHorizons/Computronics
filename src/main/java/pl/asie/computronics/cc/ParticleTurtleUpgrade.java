...
public class ParticleTurtleUpgrade extends TurtleUpgradeBase {
    ...
    private static class ParticleTurtlePeripheral extends TurtlePeripheralBase {
        ...
        public Object[] callMethod(IComputerAccess computer, ILuaContext context, int method, Object[] arguments)
            ...
            if (Config.FX_RANGE >= 0
                    && xOffset * xOffset + yOffset * yOffset + zOffset * zOffset > Config.FX_RANGE * Config.FX_RANGE) {
    ...
    public IIcon getIcon(ITurtleAccess turtle, TurtleSide side) {
        if (turtle != null) {
            ...
            return dyeColour >= 0 && dyeColour < 16 ? Blocks.stained_glass.getIcon(0, dyeColour)
                    : Blocks.glass.getIcon(0, 0);
        }
