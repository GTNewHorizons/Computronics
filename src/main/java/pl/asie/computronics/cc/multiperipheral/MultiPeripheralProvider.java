            ...
            for (IPeripheralProvider peripheralProvider : ccPeripheralProviders) {
                if (peripheralProvider != null) {
                    try {
                        ...
                        log.warn(
                                "An exception got thrown trying to get a peripheral from provider "
                                        + peripheralProvider.getClass().toString(),
                                e);
                    } catch (Throwable t) {
                        log.error(
                                "An error occured trying to get all a peripheral from provider "
                                        + peripheralProvider.getClass().toString(),
                                t);
                    }
                }
