...
public class MultiPeripheral implements IPeripheral, BlacklistedPeripheral {
            ...
            if (names != null) {
                for (String name : names) {
                    if (!methods.containsKey(name)
                            || peripheral.peripheralPriority() > methods.get(name).peripheralPriority()) {
    ...
    private Object[] callMethod(IMultiPeripheral peripheral, IComputerAccess computer, ILuaContext context,
            String methodName, Object[] arguments) throws LuaException, InterruptedException {
