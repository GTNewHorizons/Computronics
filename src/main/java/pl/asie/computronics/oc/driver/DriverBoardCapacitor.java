...
public class DriverBoardCapacitor extends RackMountableWithComponentConnector {
    ...
    public DriverBoardCapacitor(Rack host) {
        this.host = host;
        this.setNode(
                Network.newNode(this, Visibility.Network).withComponent("rack_capacitor", Visibility.Network)
                        .withConnector(Config.RACK_CAPACITOR_CAPACITY).create());
    }
    ...
    protected OCUtils.Device deviceInfo() {
        return new OCUtils.Device(DeviceClass.Power, "Battery", OCUtils.Vendors.Soluna, "CapCube 64 (Rev. 2)");
    }
