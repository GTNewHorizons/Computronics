...
public class DriverBoardBoom extends DriverCardBoom implements RackMountable {
    ...
    protected void createNode() {
        this.setNode(
                Network.newNode(this, Visibility.Network).withComponent("server_destruct", Visibility.Network)
    ...
    protected void goBoom() {
        ...
        racks.add(container);
        final Vec3 origin = Vec3
                .createVectorHelper(container.xPosition(), container.yPosition(), container.zPosition());
        Rack cur;
        while ((cur = toSearch.poll()) != null) {
            ...
            for (ForgeDirection dir : ForgeDirection.VALID_DIRECTIONS) {
                ...
                if (origin.squareDistanceTo(rx, ry, rz) <= 256 && world.blockExists(rx, ry, rz)) {
