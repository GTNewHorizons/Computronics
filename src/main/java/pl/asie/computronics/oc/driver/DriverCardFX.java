...
public class DriverCardFX extends ManagedEnvironment implements DeviceInfo {
    ...
    public DriverCardFX(EnvironmentHost container) {
        ...
        this.setNode(Network.newNode(this, Visibility.Neighbors).withComponent("particle").withConnector().create());
    }
    ...
    @Callback(
            doc = "function(name:string, xCoord:number, yCoord:number, zCoord:number [, defaultVelo:number]):boolean; "
