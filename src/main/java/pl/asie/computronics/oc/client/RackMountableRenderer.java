...
public class RackMountableRenderer {
    ...
    private final ResourceLocation boomBoardActive = new ResourceLocation(
            "computronics",
            "textures/blocks/boom_board_on.png"),
    ...
    private IIcon boomBoard, rackCapacitor, switchBoard;
    ...
    public void onRackMountableRender(RackMountableRenderEvent.TileEntity e) {
        ...
        switch (stack.getItemDamage()) {
            ...
            case 11: {
                ...
                if (e.data.getBoolean("t")
                        && (e.rack.world().getTotalWorldTime() + e.rack.hashCode() + (e.mountable * 10)) % 20 < 10) {
    ...
    private void renderOverlay(ResourceLocation texture, final float u0, final float u1, final float v0,
            final float v1) {
