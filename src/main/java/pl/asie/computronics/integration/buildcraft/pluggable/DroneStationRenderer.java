...
public class DroneStationRenderer implements IPipePluggableRenderer {
    ...
    private void droneStationPartRender(RenderBlocks renderblocks, ForgeDirection side,
            ITextureStates blockStateMachine, int x, int y, int z, float xStart, float xEnd, float yStart, float yEnd,
    ...
    @Override
    public void renderPluggable(RenderBlocks renderblocks, IPipe pipe, ForgeDirection side, PipePluggable pipePluggable,
            ITextureStates blockStateMachine, int renderPass, int x, int y, int z) {
        if (renderPass != 0) {
            return;
        }

        droneStationPartRender(
                renderblocks,
                side,
                blockStateMachine,
                x,
    ...
    public static class ItemRenderer extends ModelBase implements IItemRenderer {
        ...
        private ResourceLocation texture = new ResourceLocation(
                "computronics",
                "textures/blocks/buildcraft/pluggable/drone_station.png");
