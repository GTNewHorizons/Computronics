...
public class TileDigitalControllerBox extends TileDigitalBoxBase implements IControllerTile {
    ...
    @Callback(
            doc = "function(name:string, aspect:number):boolean; Tries to set the aspect for any paired signal with the specified name. Returns true on success.",
            direct = true,
            limit = 32)
    @Optional.Method(modid = Mods.OpenComputers)
    ...
    @Callback(
            doc = "function(aspect:number):boolean; Sets the aspect for every paired signal to the specified value. Returns true on success.",
            direct = true,
            limit = 32)
    @Optional.Method(modid = Mods.OpenComputers)
    ...
    @Callback(
            doc = "function(name:string):boolean; Tries to remove any pairing to a signal with the specified name. Returns true on success.",
            direct = true,
            limit = 32)
    @Optional.Method(modid = Mods.OpenComputers)
    ...
    @Callback(
            doc = "function():table; Returns a list containing the name of every paired receiver.",
            direct = true,
            limit = 32)
    @Optional.Method(modid = Mods.OpenComputers)
