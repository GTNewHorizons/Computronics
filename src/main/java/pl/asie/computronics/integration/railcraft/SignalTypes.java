...
public enum SignalTypes implements IIconProvider, ISignalTileDefinition {
    ...
    DigitalReceiver("digitalReceiverBox", 3.0F, true, Computronics.railcraft.digitalReceiverBox,
            TileDigitalReceiverBox.class, ForgeDirection.UP),
    DigitalController("digitalControllerBox", 3.0F, true, Computronics.railcraft.digitalControllerBox,
            TileDigitalControllerBox.class, ForgeDirection.UP);
    ...
    SignalTypes(String tag, float hardness, boolean needsSupport, Block block,
            Class<? extends TileSignalFoundation> tile, ForgeDirection direction) {
        this.tag = tag;
