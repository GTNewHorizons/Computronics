...
public class DriverLauncherTrack {
    ...
    private static Object[] setForce(TrackLauncher tile, Object[] arguments) {
        ...
        return new Object[] { false,
                "not a valid force value, needs to be between 5 and " + RailcraftConfig.getLaunchRailMaxForce() };
    }
    ...
    public static class OCDriver extends DriverSidedTileEntity {
        ...
        public ManagedEnvironment createEnvironment(World world, int x, int y, int z, ForgeDirection side) {
            return new InternalManagedEnvironment(
                    (TrackLauncher) ((TileTrack) world.getTileEntity(x, y, z)).getTrackInstance());
        }
    }
