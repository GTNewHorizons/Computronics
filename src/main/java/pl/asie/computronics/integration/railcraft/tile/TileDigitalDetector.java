...
public class TileDigitalDetector extends TileEntityPeripheralBase implements SidedEnvironment, ISidedPeripheral {
    ...
    public void updateEntity() {
        ...
        List<EntityMinecart> carts = CartTools
                .getMinecartsOnAllSides(this.worldObj, this.xCoord, this.yCoord, this.zCoord, 0.2F);
    ...
    public void readFromNBT(NBTTagCompound data) {
        ...
        direction = data.hasKey("direction") ? ForgeDirection.getOrientation(data.getByte("direction"))
                : ForgeDirection.UP;
    }
    ...
    public void readFromRemoteNBT(NBTTagCompound tag) {
        ...
        direction = tag.hasKey("direction") ? ForgeDirection.getOrientation(tag.getByte("direction"))
                : ForgeDirection.UP;
        if (oldDir != direction) {
