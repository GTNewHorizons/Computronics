...
public class ItemBlockSignalBox extends ItemBlock {
    ...
    public boolean func_150936_a(World world, int x, int y, int z, int side, EntityPlayer player, ItemStack stack) {
        ...
        return world.canPlaceEntityOnSide(this.field_150939_a, x, y, z, false, side, null, stack)
                && (!SignalTypes.DigitalReceiver.needsSupport() || world.isSideSolid(x, y - 1, z, ForgeDirection.UP));
    }
}
