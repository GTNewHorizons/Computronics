...
public class TileLocomotiveRelay extends TileEntityPeripheralBase {
    ...
    private String cannotAccessLocomotive(double amount, boolean isOC) {
        ...
        if (locomotive.getDistanceSq(xCoord, yCoord, zCoord)
    ...
    @Callback(
            doc = "function(destination:string):boolean; Sets the locomotive's destination; there needs to be a golden ticket inside the locomotive")
    @Optional.Method(modid = Mods.OpenComputers)
    ...
    @Callback(
            doc = "function():string; returns the current mode of the locomotive; can be 'running', 'idle' or 'shutdown'")
    @Optional.Method(modid = Mods.OpenComputers)
    ...
    public Object[] callMethod(IComputerAccess computer, ILuaContext context, int method, Object[] arguments)
        ...
        if (method < getMethodNames().length) {
            ...
            switch (method) {
                ...
                case 4: {
                    return new Object[] {
                            getLocomotive().func_95999_t() != null ? getLocomotive().func_95999_t() : "" };
                }
            }
        }
        return null;
