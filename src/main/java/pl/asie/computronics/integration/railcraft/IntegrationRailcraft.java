...
public class IntegrationRailcraft {
    ...
    public void preInit(Configuration config) {
        ...
        if (isEnabled(config, "digitalReceiverBox", true)) {
            ...
            FMLInterModComms
                    .sendMessage(Mods.AE2, "whitelist-spatial", TileDigitalReceiverBox.class.getCanonicalName());
        }
        if (isEnabled(config, "digitalControllerBox", true)) {
            this.digitalControllerBox = new BlockDigitalControllerBox();
            GameRegistry
                    .registerBlock(digitalControllerBox, ItemBlockSignalBox.class, "computronics.digitalControllerBox");
            GameRegistry.registerTileEntity(TileDigitalControllerBox.class, "computronics.digitalControllerBox");
            FMLInterModComms
                    .sendMessage(Mods.AE2, "whitelist-spatial", TileDigitalControllerBox.class.getCanonicalName());
        }
    ...
    public void registerRenderers() {
        ...
        MinecraftForgeClient.registerItemRenderer(
                net.minecraft.item.Item.getItemFromBlock(renderer.getBlock()),
