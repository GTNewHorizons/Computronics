...
public class DriverRoutingDetector {
    ...
    private static Object[] getRoutingTable(TileDetector tile) {
        if (((DetectorRouting) tile.getDetector()).getInventory().getStackInSlot(0) != null
            ...
            if (!((DetectorRouting) tile.getDetector()).isSecure()) {
                LinkedList<LinkedList<String>> pages = ItemRoutingTable
                        .getPages(((DetectorRouting) tile.getDetector()).getInventory().getStackInSlot(0));
                if (pages == null) {
    ...
    private static Object[] setRoutingTable(TileDetector tile, Object[] arguments) {
        ...
        if (((DetectorRouting) tile.getDetector()).getInventory().getStackInSlot(0) != null
            ...
            if (!((DetectorRouting) tile.getDetector()).isSecure()) {
                ...
                ItemRoutingTable
                        .setPages(((DetectorRouting) tile.getDetector()).getInventory().getStackInSlot(0), pages);
    ...
    public static Object[] getRoutingTableTitle(TileDetector tile) {
        if (((DetectorRouting) tile.getDetector()).getInventory().getStackInSlot(0) != null
                && ((DetectorRouting) tile.getDetector()).getInventory().getStackInSlot(0)
                        .getItem() instanceof ItemRoutingTable) {
            if (!((DetectorRouting) tile.getDetector()).isSecure()) {
                return new Object[] { RoutingTableUtil.getRoutingTableTitle(
                        ((DetectorRouting) tile.getDetector()).getInventory().getStackInSlot(0)) };
            } else {
                return new Object[] { false, "routing detector is locked" };
            }
    ...
    public static Object[] setRoutingTableTitle(TileDetector tile, Object[] arguments) {
        if (((DetectorRouting) tile.getDetector()).getInventory().getStackInSlot(0) != null
                && ((DetectorRouting) tile.getDetector()).getInventory().getStackInSlot(0)
                        .getItem() instanceof ItemRoutingTable) {
            if (!((DetectorRouting) tile.getDetector()).isSecure()) {
                return new Object[] { RoutingTableUtil.setRoutingTableTitle(
                        ((DetectorRouting) tile.getDetector()).getInventory().getStackInSlot(0),
                        (String) arguments[0]) };
            } else {
                return new Object[] { false, "routing detector is locked" };
    ...
    public static class OCDriver extends DriverSidedTileEntity {
        ...
        public static class InternalManagedEnvironment extends ManagedEnvironmentOCTile<TileDetector> {
            ...
            @Callback(
                    doc = "function():table; Returns the full routing table inside the detector, or false and an error message if there is no table or it cannot be accessed")
            public Object[] getRoutingTable(Context c, Arguments a) {
                return DriverRoutingDetector.getRoutingTable(tile);
            }

            @Callback(
                    doc = "function(routingTable:table):boolean; Sets the routing table inside the detector; argument needs to be a table with number indices and string values; returns 'true' on success, 'false' and an error message otherwise.")
            ...
            @Callback(
                    doc = "function(name:string):boolean; Sets the name of the routing table inside the detector; returns true on success")
    ...
    public static class CCDriver extends CCMultiPeripheral<TileDetector> {
        ...
        public IMultiPeripheral getPeripheral(World world, int x, int y, int z, int side) {
            ...
            if (te != null && te instanceof TileDetector
                    && ((TileDetector) te).getDetector().getType() == EnumDetector.ROUTING) {
        ...
        public String[] getMethodNames() {
            return new String[] { "getRoutingTable", "setRoutingTable", "getRoutingTableTitle",
                    "setRoutingTableTitle" };
        }
