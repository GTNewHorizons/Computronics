...
public class ItemModules extends ItemMultiple implements ModuleProvider, IModuleWithDocumentation {
    ...
    public void registerIcons(IIconRegister r) {
        ...
        /*
         * for(int i = 0; i < this.parts.length; ++i) { this.partIcons[i] = r.registerIcon(this.mod + ":tis3d/" +
         * this.parts[i]); } tapeReaderBack = r.registerIcon("computronics:tis3d/module_tape_reader_back");
         * tapeReaderCenter = r.registerIcon("computronics:module_tape_reader_center"); tapeReaderOff =
         * r.registerIcon("computronics:module_tape_reader_off");
         */
    }
    ...
    public IIcon getIconFromDamageForRenderPass(int meta, int pass) {
        /*
         * switch(meta) { case 1: { switch(pass) { case 1: return tapeReaderBack; case 2: return tapeReaderCenter; case
         * 3: return tapeReaderOff; } } default: { return super.getIconFromDamageForRenderPass(meta, pass); } }
         */
