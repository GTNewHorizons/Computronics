...
public class ModuleTapeReader extends ComputronicsModule {
    ...
    private final Command[] COMMANDS = new Command[] { new ImmediateReturnCommand("isEnd") { // isEnd
    ...
    }, new NeverWritingCommand("writeMultiple") { // write a number of bytes. First argument is the number of bytes to
                                                  // write
    ...
    private static final ResourceLocation BACK_ICON = new ResourceLocation(
            "computronics:textures/blocks/tis3d/module_tape_reader_back.png");
    private static final ResourceLocation CENTER_ICON = new ResourceLocation(
            "computronics:textures/blocks/tis3d/module_tape_reader_center.png");
    private static final ResourceLocation OFF_ICON = new ResourceLocation(
            "computronics:textures/blocks/tis3d/module_tape_reader_off.png");
    private static final ResourceLocation ON_ICON = new ResourceLocation(
            "computronics:textures/blocks/tis3d/module_tape_reader_on.png");
