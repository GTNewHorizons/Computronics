...
public class DriverEnergyReceiver {
    ...
    public static class CCDriver extends CCMultiPeripheral<IEnergyReceiver> {
        ...
        public CCDriver(IEnergyReceiver tile, World world, int x, int y, int z) {
        ...
        @Override
        public CCMultiPeripheral<IEnergyReceiver> getPeripheral(World world, int x, int y, int z, int side) {
            TileEntity te = world.getTileEntity(x, y, z);
            if (te != null && te instanceof IEnergyReceiver) {
                return new CCDriver((IEnergyReceiver) te, world, x, y, z);
            }
            return null;
        }
        ...
        public Object[] callMethod(IComputerAccess computer, ILuaContext context, int method, Object[] arguments)
            ...
            switch (method) {
                case 0: {
                    final ForgeDirection side = arguments.length > 0
                            ? ForgeDirection.getOrientation((Integer) arguments[0])
