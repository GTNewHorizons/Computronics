...
public class DriverFlamingo {
    ...
    public static class TISInterfaceProvider extends TileInterfaceProvider {
        ...
        @Override
        protected boolean isStillValid(World world, int x, int y, int z, EnumFacing side,
                SerialInterface serialInterface, TileEntity tile) {
            return tile instanceof TileEntityFlamingo && serialInterface instanceof InternalSerialInterface
