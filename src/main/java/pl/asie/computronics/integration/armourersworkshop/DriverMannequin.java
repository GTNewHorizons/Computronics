...
public class DriverMannequin {
    ...
    public static Object[] setRotation(TileEntityMannequin tile, String partName, Double rotationX, Double rotationY,
            Double rotationZ) {
    ...
    public static Object[] getRotation(TileEntityMannequin tile, String partName) {
        BipedPart part = getPart(tile, partName);
        if (part != null) {
            return new Object[] { Math.toDegrees(part.rotationX), Math.toDegrees(part.rotationY),
                    Math.toDegrees(part.rotationZ) };
        }
    ...
    public static class OCDriver extends DriverSidedTileEntity {
        ...
        public static class InternalManagedEnvironment extends ManagedEnvironmentOCTile<TileEntityMannequin> {
            ...
            @Callback(
                    doc = "function(part:string, x:number or nil , y:number or nil , z:number or nil); Sets the rotation (in degrees) of the mannequin.")
            ...
            @Callback(
                    doc = "function(part:string):number, number, number; Returns the rotation of the mannequin, in degrees.",
                    direct = true)
            ...
            @Callback(
                    doc = "function(part:string):number; Returns the X rotation of the mannequin, in degrees.",
                    direct = true)
            ...
            @Callback(
                    doc = "function(part:string):number; Returns the Y rotation of the mannequin, in degrees.",
                    direct = true)
            ...
            @Callback(
                    doc = "function(part:string):number; Returns the Z rotation of the mannequin, in degrees.",
                    direct = true)
    ...
    public static class CCDriver extends CCMultiPeripheral<TileEntityMannequin> {
        ...
        @Override
        public CCMultiPeripheral<TileEntityMannequin> getPeripheral(World world, int x, int y, int z, int side) {
        ...
        public String[] getMethodNames() {
            return new String[] { "setRotation", "setRotationX", "setRotationY", "setRotationZ", "getRotation",
                    "getRotationX", "getRotationY", "getRotationZ", "parts" };
        }
