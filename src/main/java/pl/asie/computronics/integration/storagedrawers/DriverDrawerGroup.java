...
public class DriverDrawerGroup {
    ...
    public static class OCDriver extends DriverSidedTileEntity {
        ...
        public static class InternalManagedEnvironment extends ManagedEnvironmentOCTile<IDrawerGroup> {
            ...
            @Callback(
                    doc = "function(drawerslot:number):number; Returns the number of items in the specified drawer slot.")
            ...
            @Callback(
                    doc = "function(drawerslot:number):number; Returns the maximum number of items that can be stored in the specified drawer slot.")
            ...
            @Callback(
                    doc = "function(drawerslot:number):string; Returns the name of the item in the specified drawer slot")
            ...
            @Callback(
                    doc = "function(drawerslot:number):number; Returns the damage value of the item in the specified drawer slot")
