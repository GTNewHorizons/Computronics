...
public class SwarmBehavior extends AbstractBehavior {
    ...
    public void onDisable(DisableReason reason) {
        if (entity != null) {
            if (reason != DisableReason.Default
    ...
    /*
     * public void readFromNBT(NBTTagCompound tag) { //entityTag = tag.getCompoundTag("computronics:swarm"); //if(entity
     * != null) { //entity.readFromNBT(entityTag); //} } public void writeToNBT(NBTTagCompound tag) { //if(entity !=
     * null) { //entityTag = new NBTTagCompound(); //entity.writeToNBT(entityTag); //}
