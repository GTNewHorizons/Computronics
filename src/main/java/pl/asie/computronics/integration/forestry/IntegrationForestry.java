...
public class IntegrationForestry {
    ...
    private static final String speciesAgrarian = "forestry.speciesAgrarian", speciesExotic = "forestry.speciesExotic",
    ...
    public void initOC() {
        ...
        sea = AlleleManager.alleleFactory.createFlowers(
                Mods.Computronics,
                "flowers",
                "sea",
                providerSea,
        ...
        speciesScummy = BeeManager.beeFactory
                .createSpecies(
                        "computronics.speciesScummy",
                        false,
                        "Sangar",
                        "computronics.bees.species.scummy",
                        "computronics.bees.species.scummy.description",
                        pirates,
                        "ebriosus",
                        0x00DF1F,
                        0xffdc16)
        ...
        scummyA = BeeManager.beeMutationFactory.createMutation(
                ...
                (IAlleleBeeSpecies) AlleleManager.alleleRegistry.getAllele(speciesExotic),
                getScummyTemplate(),
                2);
        if (shortMead != null) {
            scummyA.requireResource(shortMead, 0);
        }
        scummyA.restrictBiomeType(Type.OCEAN, Type.HOT).restrictBiomeType(Type.OCEAN, Type.WET).requireNight()
                .restrictTemperature(EnumTemperature.WARM, EnumTemperature.HELLISH).setIsSecret();
        ...
        RecipeManagers.centrifugeManager.addRecipe(40, new ItemStack(itemPartsForestry, 1, 0), acidRecipe);
        ...
        RecipeUtils.addShapelessRecipe(
                undisassemblable(Items.get("acid").createItemStack(1)),
