...
public class EntitySwarmBeeFX extends EntityFXBee {
    ...
    public EntitySwarmBeeFX(World world, double x, double y, double z, int color) {
        ...
        /*
         * this.motionX = this.motionX / 0.2D * 0.12D; this.motionY = this.motionY / 0.015D * 0.12D; this.motionZ =
         * this.motionZ / 0.2D * 0.12D;
         */
        /*
         * this.motionX *= 0.2D; this.motionY *= 0.015D; this.motionZ *= 0.2D;
         */
    }
