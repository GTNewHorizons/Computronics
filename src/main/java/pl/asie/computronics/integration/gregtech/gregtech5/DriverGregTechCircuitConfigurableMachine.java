...
public class DriverGregTechCircuitConfigurableMachine extends DriverSidedTileEntity {
    ...
    public static class ManagedEnvironmentGregTechCircuitConfig extends ManagedEnvironmentOCTile<IMetaTileEntity> {
        ...
        @Callback(
                doc = "function():number; Gets the circuit configuration. Returns -1 if no circuit or not applicable.")
        ...
        @Callback(
                doc = "function(config:number):boolean or (nil, string); Sets the circuit configuration. Use -1 to remove circuit. Returns true on success.")
        public Object[] setCircuitConfiguration(Context context, Arguments args) {
            ...
            if (config == NO_CONFIG) {
                ...
                return new Object[] { null,
                        "Invalid circuit configuration value: " + config
