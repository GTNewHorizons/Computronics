...
public class DriverTelepad {
    ...
    public static class OCDriver extends DriverSidedTileEntity {
        ...
        public class InternalManagedEnvironment extends ManagedEnvironmentOCTile<ITelePad> {
            ...
            @Callback(
                    doc = "function(xCoord:number):number; Changes the x coordinate the telepad is set to; Returns the new x coordinate")
            ...
            @Callback(
                    doc = "function(yCoord:number):number; Changes the y coordinate the telepad is set to; Returns the new y coordinate")
            ...
            @Callback(
                    doc = "function(zCoord:number):number; Changes the z coordinate the telepad is set to; Returns the new z coordinate")
            ...
            @Callback(
                    doc = "function(xCoord:number, yCoord:number, zCoord:number):number, number, number; Changes the coordinates the telepad is set to; Returns the new coordinates")
            ...
            @Callback(
                    doc = "function(dimension:number):number; Changes the dimension the telepad is set to; Returns the new dimension")
    ...
    public static class CCDriver extends CCMultiPeripheral<ITelePad> {
        ...
        public String[] getMethodNames() {
            return new String[] { "getX", "getY", "getZ", "getCoords", "getDimension", "setX", "setY", "setZ",
                    "setCoords", "setDimension", "teleport", "isValid" };
        }
