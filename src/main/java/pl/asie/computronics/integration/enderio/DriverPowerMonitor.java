...
public class DriverPowerMonitor {
    ...
    public static class OCDriver extends DriverSidedTileEntity {
        ...
        public static class InternalManagedEnvironment extends ManagedEnvironmentOCTile<TilePowerMonitor> {
            ...
            @Callback(
                    doc = "function(level:number); Sets the level at which the monitor should start emitting redstone")
    ...
    public static class CCDriver extends CCMultiPeripheral<TilePowerMonitor> {
        ...
        public String[] getMethodNames() {
            return new String[] { "getPowerInConduits", "getMaxPowerInConduits", "getPowerInCapBanks",
                    "getMaxPowerInCapBanks", "getPowerInMachines", "getMaxPowerInMachines", "getAverageEnergySent",
                    "getAverageEnergyReceived", "isEngineControlEnabled", "setEngineControlEnabled", "getStartLevel",
                    "setStartLevel", "getStopLevel", "setStopLevel" };
        }
