...
public class DriverTransceiver {
    ...
    private static Object[] getSendChannels(TileTransceiver tile, Object[] arguments) {
        ...
        try {
            channelList = tile
                    .getSendChannels(ChannelType.valueOf(((String) arguments[0]).toUpperCase(Locale.ENGLISH)));
    ...
    private static Object[] setSendChannel(TileTransceiver tile, Object[] arguments) {
        ...
        try {
            channels = shouldAdd
                    ? ServerChannelRegister.instance.getChannelsForType(
                            ChannelType.valueOf(((String) arguments[0]).toUpperCase(Locale.ENGLISH)))
    ...
    private static Object[] getReceiveChannels(TileTransceiver tile, Object[] arguments) {
        ...
        try {
            channelList = tile
                    .getRecieveChannels(ChannelType.valueOf(((String) arguments[0]).toUpperCase(Locale.ENGLISH)));
        } catch (IllegalArgumentException e) {
            throw new IllegalArgumentException("No valid channel type given");
        }
        return parseChannels(channelList);
    ...
    private static Object[] addChannel(TileTransceiver tile, Object[] arguments) {
        Collection<Channel> channels;
        try {
            channels = ServerChannelRegister.instance
                    .getChannelsForType(ChannelType.valueOf(((String) arguments[0]).toUpperCase(Locale.ENGLISH)));
        } catch (IllegalArgumentException e) {
            throw new IllegalArgumentException("No valid channel type given");
        }
        if (channels != null) {
    ...
    private static Object[] getChannels(TileTransceiver tile, Object[] arguments) {
        Collection<Channel> channelList;
        try {
            channelList = ServerChannelRegister.instance
                    .getChannelsForType(ChannelType.valueOf(((String) arguments[0]).toUpperCase(Locale.ENGLISH)));
        } catch (IllegalArgumentException e) {
            throw new IllegalArgumentException("No valid channel type given");
        }
    ...
    public static class OCDriver extends DriverSidedTileEntity {
        ...
        public static class InternalManagedEnvironment extends ManagedEnvironmentOCTile<TileTransceiver> {
            ...
            @Callback(
                    doc = "function(channeltype:string,name:string,shouldSend:boolean):boolean; Sets whether the transceiver should send to the specified channel")
            ...
            @Callback(
                    doc = "function(channeltype:string):table; Returns a table of channels the transceiver receives from")
            ...
            @Callback(
                    doc = "function(channeltype:string,name:string,shouldReceive:boolean):boolean; Sets whether the transceiver should receive from the specified channel")
            ...
            @Callback(
                    doc = "function(channeltype:string,name:string):boolean; Adds a channel to the public channel list if possible")
            ...
            @Callback(
                    doc = "function(channeltype:string,name:string):boolean; Removes a channel from the public channel list if possible")
            ...
            @Callback(
                    doc = "function(channeltype:string,name:string):boolean; Returns whether the specified channel exists")
            ...
            @Callback(
                    doc = "function(channeltype:string,name:string):boolean; Returns whether the transceiver sends to the specified channel")
            ...
            @Callback(
                    doc = "function(channeltype:string,name:string):boolean; Returns whether the transceiver receives from the specified channel")
    ...
    public static class CCDriver extends CCMultiPeripheral<TileTransceiver> {
        ...
        @Override
        public CCMultiPeripheral<TileTransceiver> getPeripheral(World world, int x, int y, int z, int side) {
        ...
        public String[] getMethodNames() {
            return new String[] { "getSendChannels", "setSendChannel", "getReceiveChannels", "setReceiveChannel",
                    "addChannel", "removeChannel", "isChannelExisting", "getChannels", "isSendChannel",
                    "isReceiveChannel", "getChannelTypes" };
        }
