...
public class DriverCapacitorBank {
    ...
    private static Object[] getRedstoneMode(TileCapBank tile, boolean input) {
        ...
        return new Object[] {
                tile.getNetwork() != null ? tile.getNetwork().getOutputControlMode().name().toLowerCase(Locale.ENGLISH)
    ...
    private static Object[] setRedstoneMode(TileCapBank tile, String mode, boolean input) {
        try {
            if (input) {
                if (tile.getNetwork() != null) {
                    tile.getNetwork()
                            .setInputControlMode(RedstoneControlMode.valueOf(mode.toUpperCase(Locale.ENGLISH)));
                } else {
                ...
                if (tile.getNetwork() != null) {
                    tile.getNetwork()
                            .setOutputControlMode(RedstoneControlMode.valueOf(mode.toUpperCase(Locale.ENGLISH)));
                } else {
    ...
    public static class CCDriver extends CCMultiPeripheral<TileCapBank> {
        ...
        public String[] getMethodNames() {
            return new String[] { "getAverageInputPerTick", "getAverageOutputPerTick", "getAverageChangePerTick",
                    "setMaxInput", "setMaxOutput", "getInputMode", "getOutputMode", "setInputMode", "setOutputMode",
                    "getRedstoneModeTable" };
        }
