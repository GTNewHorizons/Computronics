...
/**
 * Allows you to register instances of {@link pl.asie.computronics.api.multiperipheral.IMultiPeripheralProvider}.
 * <p/>
 * You need to send a method registering your instances of
 * {@link pl.asie.computronics.api.multiperipheral.IMultiPeripheralProvider} using
 * {@link cpw.mods.fml.common.event.FMLInterModComms#sendMessage}.
 * <p/>
 * Note that method sent must have the following signature:
 * 
 * <pre>
 ...
 * <pre>
 * FMLInterModComms
 *         .sendMessage("Computronics", "addmultiperipherals", "com.example.examplemod.cc.MultiPeripherals.register");
 * </pre>
 */
