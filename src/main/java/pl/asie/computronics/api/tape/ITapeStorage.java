...
public interface ITapeStorage {
    ...
    /**
     * Sets the position of the tape. I would very much ask for you **NEVER** to interface this to players in any way,
     * shape or form, due to it breaking the delicate balance of the ITapeStorage system.
     * 
     ...
     * Read a single byte.
     * 
     * @param simulate If true, do not automatically seek the tape. Like setPosition, this should NOT be interfaced to
     *                 players.
