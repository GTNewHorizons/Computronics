...
@Mod(
        modid = Mods.Computronics,
        name = Mods.Computronics_NAME,
        version = Mods.Computronics_VERSION,
        dependencies = "required-after:asielib@[0.4.9,);required-after:Forge@[10.13.2.1291,);"
                ...
                + "after:EnderIO@[1.7.10-2.3.0.424,);after:Forestry;after:Waila@[1.5.10,);"
...
public class Computronics {
    ...
    private void registerBlockWithTileEntity(BlockBase block, Class<? extends ItemBlock> itemBlock,
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        if (isEnabled("cipher_advanced", true)) {
            ...
            rsaThreads = Executors
                    .newFixedThreadPool(2, new ThreadFactoryBuilder().setPriority(Thread.MIN_PRIORITY).build());
        }
    ...
    public void init(FMLInitializationEvent event) {
        ...
        FMLInterModComms.sendMessage(
                Mods.Waila,
                "register",
                "pl.asie.computronics.integration.waila.IntegrationWaila.register");
    ...
    /**
     * Registers a new {@link IMultiPeripheralProvider}. If you want to hook into this, do it between Computronics'
     * preInit and init phase
     */
                ...
                if (message.key.equalsIgnoreCase("addmultiperipherals") && message.isStringMessage()) {
                    if (peripheralRegistry != null) {
                        ...
                        log.warn(
                                String.format(
                                        Locale.ENGLISH,
                                        "Mod (%s) tried to register MultiPeripheral before Computronics' preInit!",
                                        message.getSender()));
                    }
                }
            }
