...
public class Mods {
    ...
    // Other mods
    public static final String AE2 = "appliedenergistics2", ArmourersWorkshop = "armourersWorkshop",
            BetterStorage = "betterstorage", BuildCraftCore = "BuildCraft|Core",
            BuildCraftTransport = "BuildCraft|Transport", EnderIO = "EnderIO", Factorization = "factorization",
            Flamingo = "Flamingo", Forestry = "Forestry", FSP = "Steamcraft", GregTech = "gregtech",
            MFR = "MineFactoryReloaded", OpenBlocks = "OpenBlocks", OpenPeripheral = "OpenPeripheralCore",
            RedLogic = "RedLogic", ProjectRed = "ProjRed|Core", Railcraft = "Railcraft",
            StorageDrawers = "StorageDrawers", Waila = "Waila";

    // APIs
    public static class API {

        public static final String BuildCraftBlueprints = "BuildCraftAPI|blueprints",
                BuildCraftStatements = "BuildCraftAPI|statements", BuildCraftTiles = "BuildCraftAPI|tiles",
                CoFHAPI_Energy = "CoFHAPI|energy", DraconicEvolution = "DraconicEvolution|API",
                Gendustry = "gendustryAPI", Mekanism_Energy = "MekanismAPI|energy";
