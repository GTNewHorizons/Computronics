...
public class BlockColorfulLamp extends BlockPeripheral implements IRedNetInputNode {
    ...
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float _x, float _y,
            float _z) {
                ...
                if (held != null && held.getItem() != null
                    ...
                    player.addChatMessage(
                            new ChatComponentTranslation(
                                    "chat.computronics.lamp.binary." + (lamp.isBinaryMode() ? "on" : "off")));
                    return true;
                }
            }
        }
    ...
    public void setLightValue(int value) {
        if (LampUtil.shouldColorLight()) {
            ...
            int r = (((value & 0x7C00) >>> 10) / 2), g = (((value & 0x03E0) >>> 5) / 2), b = ((value & 0x001F) / 2);
