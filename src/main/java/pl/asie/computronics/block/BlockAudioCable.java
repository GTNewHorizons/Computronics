...
public class BlockAudioCable extends BlockBase implements IBlockWithDocumentation {
    ...
    @Override
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int a, float _x, float _y,
            float _z) {
    ...
    private static class BoundingBox {
        ...
        private static void setupBounds() {
            ...
            for (int mask = 0; mask <= 0xFF >> 2; ++mask) {
                ...
                bounds.setBounds(
                        clamp(bounds.minX + 0.5),
                        clamp(bounds.minY + 0.5),
                        clamp(bounds.minZ + 0.5),
                        clamp(bounds.maxX + 0.5),
                        clamp(bounds.maxY + 0.5),
                        clamp(bounds.maxZ + 0.5));
    ...
    /*
     * @Override public void addCollisionBoxesToList(World world, int x, int y, int z, AxisAlignedBB aabb, List boxes,
     * Entity entity) { boxes.add(AxisAlignedBB.getBoundingBox(x + 0.3125, y + 0.3125, z + 0.3125, x + 1 - 0.3125, y + 1
     * - 0.3125, z + 1 - 0.3125)); TileAudioCable tac = (TileAudioCable) world.getTileEntity(x, y, z); if(tac != null) {
     * for(int i = 0; i < 6; i++) { if(tac.connects(ForgeDirection.getOrientation(i))) { switch(i) { case 0:
     * boxes.add(AxisAlignedBB.getBoundingBox(x + 0.3125, y, z + 0.3125, x + 1 - 0.3125, y + 0.3125, z + 1 - 0.3125));
     * break; case 1: boxes.add(AxisAlignedBB.getBoundingBox(x + 0.3125, y + 1 - 0.3125, z + 0.3125, x + 1 - 0.3125, y +
     * 1, z + 1 - 0.3125)); break; case 2: boxes.add(AxisAlignedBB.getBoundingBox(x + 0.3125, y + 0.3125, z, x + 1 -
     * 0.3125, y + 1 - 0.3125, z + 0.3125)); break; case 3: boxes.add(AxisAlignedBB.getBoundingBox(x + 0.3125, y +
     * 0.3125, z + 1 - 0.3125, x + 1 - 0.3125, y + 1 - 0.3125, z + 1)); break; case 4:
     * boxes.add(AxisAlignedBB.getBoundingBox(x, y + 0.3125, z + 0.3125, x + 0.3125, y + 1 - 0.3125, z + 1 - 0.3125));
     * break; case 5: boxes.add(AxisAlignedBB.getBoundingBox(x + 1 - 0.3125, y + 0.3125, z + 0.3125, x + 1, y + 1 -
     * 0.3125, z + 1 - 0.3125)); break; } } } } }
     */
