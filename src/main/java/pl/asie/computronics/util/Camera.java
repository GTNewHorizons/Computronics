...
public class Camera {
    ...
    public boolean ray(World worldObj, double xCoord, double yCoord, double zCoord, ForgeDirection dir, float x,
            float y, boolean doBlockOffset) {
        hit = null;
        ...
        if (dir != null) {
            ...
            Vec3 target = Vec3.createVectorHelper(
                    xPos + (xDirection * steps),
                    yPos + (yDirection * steps),
                    zPos + (zDirection * steps));
