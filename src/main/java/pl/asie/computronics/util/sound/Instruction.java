...
public abstract class Instruction {
    ...
    public static class SetFM extends ChannelSpecific {
        ...
        public SetFM(NBTTagCompound tag) {
            super(tag.getByte("c"));
            this.freqMod = new FrequencyModulation(tag.getInteger("m"), tag.getFloat("i"));
        }
    ...
    public static class SetADSR extends ChannelSpecific {
        ...
        public SetADSR(int channelIndex, int attackDuration, int decayDuration, float attenuation,
                int releaseDuration) {
            super(channelIndex);
        ...
        public SetADSR(NBTTagCompound tag) {
            super(tag.getByte("c"));
            this.envelope = new ADSR(tag.getInteger("a"), tag.getInteger("d"), tag.getFloat("s"), tag.getInteger("r"));
        }
