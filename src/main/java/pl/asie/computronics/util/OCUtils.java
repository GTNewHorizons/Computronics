...
public class OCUtils {
    ...
    public static final class Vendors {
        ...
        public static final String ACME = "ACME Co.", BuildCraft = "BuildCraft, Inc.", DFKI = "DFKI GmbH",
                Hosencorp = "Hosencorp AG", HuggingCreeper = "Hugging Creeper Industries", Lumiose = "Lumiose Lighting",
                NSA = "National Security Agency", Railcraft = "Railcraft, Inc.", Siekierka = "Siekierka Innovations",
                Soluna = "Soluna Technologies", Trumbour = "Trumbour Technology", Yanaki = "Yanaki Sound Systems";
    ...
    public static void addTooltip(ItemStack stack, List<String> tooltip, boolean advanced) {
        {
            ...
            if (!tip.equals(key)) {
                ...
                if (font == null) {
                    ...
                    boolean shouldShorten = (font.getStringWidth(tip) > maxWidth)
                            && !KeyBindings.showExtendedTooltips();
                    if (shouldShorten) {
                        tooltip.add(
        ...
        if (stack.hasTagCompound() && stack.getTagCompound().hasKey("oc:data")) {
            ...
            if (data.hasKey("node") && data.getCompoundTag("node").hasKey("address")) {
                tooltip.add(
                        EnumChatFormatting.DARK_GRAY + data.getCompoundTag("node").getString("address").substring(0, 13)
                                + "..."
    ...
    private static final EnumRarity[] rarities = new EnumRarity[] { EnumRarity.common, EnumRarity.uncommon,
