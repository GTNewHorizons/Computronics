 ...
 * @author Vexatos
 */
@Optional.InterfaceList({ @Optional.Interface(iface = "li.cil.oc.api.machine.Value", modid = Mods.OpenComputers),
...
public class RSAValue implements Value, ILuaObject {
    ...
    @Callback(
            doc = "function():table,table; Returns the two generated keys, or nil if they are still being generated",
            direct = true)
