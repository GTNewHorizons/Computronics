...
public class TextToSpeechLoader {
    ...
    /*
     * static { ClassLoader classLoader = TextToSpeech.class.getClassLoader(); System.out.println("Classloader: " +
    ...
    public boolean preInit() {
        ...
        if (!ttsDir.exists()) {
            log.info(
                    "No MaryTTS directory found, you will not be able to use Text To Speech unless the server you are playing on has MaryTTS installed. To use TTS, install MaryTTS into the marytts directory of your minecraft instance.");
        ...
        try {
            ...
            // Taken from Mary.configureLogging, needs to be called manually due to the logger already being loaded by
            // this time.
            {
